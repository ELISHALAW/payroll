            ...
            <form action="{{ route('login.authenticate') }}" method="POST" class="space-y-5">
                ...
                <div class="relative">
                    ...
                    <div class="relative group">
                        ...
                        <i class="bx bx-envelope absolute right-5 top-1/2 -translate-y-1/2 text-xl text-gray-400 group-focus-within:text-gray-800 transition-colors"></i>
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div class="relative group">
                        <input type="password" name="password" placeholder="Enter your password" 
                               class="w-full h-12 pl-5 pr-12 border border-gray-300 rounded-full focus:border-gray-800 focus:ring-1 focus:ring-gray-800 outline-none transition-all placeholder:text-gray-400 font-light {{ $errors->has('email') ? 'border-red-500 bg-red-50' : 'border-gray-300 focus:border-gray-800' }}"">
                        <i class="bx bx-lock-alt absolute right-5 top-1/2 -translate-y-1/2 text-xl text-gray-400 group-focus-within:text-gray-800 transition-colors"></i>
                    </div>
                </div>
                @if ($errors->any())
                ...
                {{-- Sign in button --}}
                <button type="submit" class="w-full h-12 bg-gray-900 text-white rounded-full font-bold hover:bg-black transition-all shadow-md active:scale-[0.98]">
                    Sign in
                </button>
            </form>
