...
@section('content')
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('admin.users.create') }}" class="bg-gray-900 text-white px-4 py-2 rounded-lg text-sm font-bold">
                + Add New User
            </a>
        </div>
                ...
                <tbody class="divide-y divide-gray-100 text-xs uppercase">
                    @foreach ($users as $user)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="py-3 px-4">
                                <span
                                    class="px-2 py-1 rounded-full text-xs font-bold {{ $user->role == 'admin' ? 'bg-purple-100 text-purple-700' : 'bg-blue-100 text-blue-700' }}">
