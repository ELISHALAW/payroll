        ...
        <div class="max-w-2xl mx-auto bg-white shadow-lg rounded-xl overflow-hidden border border-gray-100">
            ...
            <form action="{{ route('companies.update', $company->id) }}" method="POST" class="p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="registration_no"
                            value="{{ old('registration_no', $company->registration_no) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="country" value="{{ old('country', $company->country) }}" required
                            class="w-full border-gray-300 rounded-lg shadow-sm p-2.5 bg-gray-100 cursor-not-allowed"
                            readonly>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-100">
                    ...
                    <button type="submit"
                        class="bg-gray-900 hover:bg-gray-700 text-white font-bold py-2.5 px-8 rounded-lg shadow-md transition transform hover:-translate-y-0.5">
                        Update Company
                    </button>
                </div>
            </form>
