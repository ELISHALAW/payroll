                                ...
                                <div
                                    ...
                                    <div class="flex items-baseline gap-3">
                                        <span class="text-sm font-bold text-slate-700">
                                            {{ Carbon::parse($offday->value)->format('d F Y') }}
                                        </span>
                                        <span class="text-xs italic text-slate-400 font-medium">
                                            ({{ Carbon::parse($offday->value)->format('l') }})
                                        </span>
                                    </div>

                                    <form action="{{ route('user.offday.delete', $offday->id) }}" method="POST"
                                        onsubmit="return confirm('Are you sure you want to delete this offday?');">
                                        @csrf
                                        @method('DELETE')
