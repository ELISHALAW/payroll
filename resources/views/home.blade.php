        ...
        <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-center relative z-10">
            ...
            <div class="md:w-1/2 text-center md:text-left mb-10 md:mb-0">
                ...
                <p class="text-gray-400 text-lg mb-8 max-w-lg">
                    The most intuitive way to manage employee salaries, taxes, and attendance. Built for modern Malaysian businesses.
                </p>
                <div class="flex flex-col sm:flex-row justify-center md:justify-start gap-4">
                    <a href="/login" class="px-8 py-3 bg-blue-600 text-white rounded-full font-bold hover:bg-blue-700 transition shadow-lg text-center">
                        Get Started
                    </a>
                    <a href="#" class="px-8 py-3 border border-gray-600 text-white rounded-full font-bold hover:bg-gray-800 transition text-center">
                        Watch Demo
                    </a>
                </div>
            </div>
            ...
            <div class="md:w-1/2 flex justify-center">
                <div class="relative">
                    <div class="w-64 h-64 md:w-80 md:h-80 bg-blue-600 rounded-full blur-3xl opacity-20 absolute top-0 -left-10"></div>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition">
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed">Calculate EPF, SOCSO, and EIS automatically with one click based on current laws.</p>
                </div>

                {{-- Card 2 --}}
                <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition">
                    <div class="w-12 h-12 bg-green-100 text-green-600 rounded-xl flex items-center justify-center text-2xl mb-6">
                        <i class="bx bx-shield-quarter"></i>
                    </div>
                    <h3 class="text-xl font-bold mb-3">Highly Secure</h3>
                    <p class="text-gray-600 text-sm leading-relaxed">Your data is encrypted and protected. Only authorized HR managers can access sensitive info.</p>
                </div>

                {{-- Card 3 --}}
                <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition">
                    <div class="w-12 h-12 bg-purple-100 text-purple-600 rounded-xl flex items-center justify-center text-2xl mb-6">
                        <i class="bx bx-file"></i>
                    </div>
                    <h3 class="text-xl font-bold mb-3">E-Payslips</h3>
                    <p class="text-gray-600 text-sm leading-relaxed">Employees can view and download their monthly payslips directly from their dashboard.</p>
                </div>
            </div>
        </div>
    </section>
